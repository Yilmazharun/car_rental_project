...
def export_excel_users(request):
    if request.method == "GET":
        ...
        response["Content-Disposition"] = (
            "attachment; filename=Users_" + str(datetime.datetime.now()) + ".xls"
        )
...
def export_excel_cars(request):
    ...
    if request.method == "GET":
        ...
        response = HttpResponse(content_type="application/ms-excel")
        response["Content-Disposition"] = (
            "attachment; filename=Cars_" + str(datetime.datetime.now()) + ".xls"
        )
...
def export_excel_reservations(request):
    ...
    if request.method == "GET":
        ...
        response = HttpResponse(content_type="application/ms-excel")
        response["Content-Disposition"] = (
            "attachment; filename=Reservations_" + str(datetime.datetime.now()) + ".xls"
        )
        ...
        rows = Reservation.objects.all().values_list(
            "id",
            "pickUpTime",
            "dropOffTime",
            "car_id",
